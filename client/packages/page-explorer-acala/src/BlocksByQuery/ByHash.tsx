...
import { AddressSmall, Columar, Expander, LinkExternal, Table } from '@polkadot/react-components';
      ...
      {myError
        ...
        : getBlock && getHeader && !getBlock.isEmpty && !getHeader.isEmpty && (
          ...
          >
            ...
            <tr>
              {getBlock && getHeader && blockNumber && (
                <td colSpan={6}>
                  <Expander summary={"Block" + blockNumber.toString() + "- Click to Expand"}>
